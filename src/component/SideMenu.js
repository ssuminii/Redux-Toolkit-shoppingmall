...
const SideMenu = ({ authenticate, setAuthenticate }) => {
            ...
            <div className='all-nav'>
                ...
                <div className='login-button'>
                    ...
                    <div className='input-text'>
                        <FontAwesomeIcon icon={faSearch} onClick={toggleInput}/>
                        {isInputVisible && (
                        <input
                            type="text"
                            placeholder='제품검색'
